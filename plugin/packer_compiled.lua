...
_G.packer_plugins = {
  ...
  ["horizon.nvim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/horizon.nvim",
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
